...
Start by plotting self-reported friend group party ID (both 3 and 5-level
representations) by a person's individual party ID. For more information on the
`make_plot` function, see the appendix at the bottom.
```{r}
