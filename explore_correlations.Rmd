...
make_plot_base <- function(
  ...
  color_palettes <- list(
    ...
    friend_group_pid5 = c("blue", "lightblue", "purple", "pink", "red", "grey"),
    # colors created using ColorBrewer 2.0
    # https://colorbrewer2.org/?type=sequential&scheme=YlGnBu&n=5
    friend_group_class = c('#ffffcc','#a1dab4','#41b6c4','#2c7fb8','#253494', "grey")
  )
