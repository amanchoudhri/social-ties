...
![](figs/examine_friend_group_pid3/unnamed-chunk-6-1.png)<!-- -->
...
![](figs/examine_friend_group_pid3/unnamed-chunk-13-1.png)<!-- -->

``` r
bar_plot('collapsed_pid', 'county_leaning')
```

![](figs/examine_friend_group_pid3/unnamed-chunk-14-1.png)<!-- -->
