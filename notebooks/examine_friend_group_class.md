...
In this notebook, we explore the covariate `friend_group_class`.
...
Start by plotting friend_group_class by a person’s individual party ID.

``` r
dot_plot('collapsed_pid')
```

![](figs/examine_friend_group_class/pid-dot-1.png)<!-- -->
...
![](figs/examine_friend_group_class/pid-bar-1.png)<!-- -->
...
![](figs/examine_friend_group_class/social-class-1.png)<!-- -->
...
![](figs/examine_friend_group_class/pid-state-1.png)<!-- -->
...
![](figs/examine_friend_group_class/pid-state-cop-1.png)<!-- -->
...
![](figs/examine_friend_group_class/pid-county-1.png)<!-- -->
...
![](figs/examine_friend_group_class/pid-county-cop-1.png)<!-- -->
...
![](figs/examine_friend_group_class/urbanicity-bar-1.png)<!-- -->
...
![](figs/examine_friend_group_class/pid-urbanicity-1.png)<!-- -->
